...
import com.gaogeek.tab.support.view.accessibility.*;
...
public class AccessibilityNodeProviderCompat {
            ...
            return AccessibilityNodeProviderCompatJellyBean.newAccessibilityNodeProviderBridge(
                    new AccessibilityNodeProviderCompatJellyBean.AccessibilityNodeInfoBridge() {
                        ...
                        public List<Object> findAccessibilityNodeInfosByText(
                            ...
                            final List<com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat> compatInfos =
                            ...
                            if (compatInfos == null) {
                                ...
                                for (int i = 0; i < infoCount; i++) {
                                    com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat infoCompat = compatInfos.get(i);
                        ...
                        public Object createAccessibilityNodeInfo(
                                int virtualViewId) {
                            final com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat compatInfo =
            ...
            return AccessibilityNodeProviderCompatKitKat.newAccessibilityNodeProviderBridge(
                    new AccessibilityNodeProviderCompatKitKat.AccessibilityNodeInfoBridge() {
                        ...
                        public Object findFocus(int focus) {
                            final com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat compatInfo = compat.findFocus(focus);
                            if (compatInfo == null) {
                                return null;
                            } else {
                                return compatInfo.getInfo();
    ...
    /**
     * Returns an {@link com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat} representing a virtual view,
     ...
     * @return A populated {@link com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat} for a virtual descendant
     *     or the host View.
     *
     * @see com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat
     */
    @Nullable
    public com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat createAccessibilityNodeInfo(int virtualViewId) {
        return null;
    }
    ...
    /**
     * Finds {@link com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat}s by text. The match is case insensitive
     ...
     */
    @Nullable
    public List<com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat> findAccessibilityNodeInfosByText(String text,
                                                                                                                    int virtualViewId) {
        return null;
    }
     ...
     *            {@link com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat#FOCUS_INPUT} or
     *            {@link com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat#FOCUS_ACCESSIBILITY}.
     * @return The node info of the focused view or null.
     * @see com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat#FOCUS_INPUT
     * @see com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat#FOCUS_ACCESSIBILITY
     */
    @Nullable
    public com.gaogeek.tab.support.view.accessibility.AccessibilityNodeInfoCompat findFocus(int focus) {
        return null;
    }
}
